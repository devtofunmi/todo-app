              ...
              {tasks
                ...
                .map((task) => (
                  <li key={`uncompleted-${task.id}`}>
                    <div className="flex justify-between border-[1px] border-white hover:bg-[#181819] hover:border-[#181819] cursor-pointer my-3  p-3 rounded-md hover:bg-btntext hover:text-[#4cbf87]">
                      <div>
                        <h1
